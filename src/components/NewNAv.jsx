...
const NewNav = () => {
  ...
  return (
    <>
      {/* ---------- MAIN BAR ---------- */}
      <div className="bg-[#F8B179] z-[900px] md:w-[70%] w-[90%] mx-auto mt-2 rounded-full px-4 sm:px-16 py-3">
        <nav className="relative z-[900px] flex items-center justify-between text-white text-sm">
          

          {/* Desktop links */}
          <div className="hidden md:flex items-center gap-8">
            <a href="/" className="hover:text-slate-300 text-[#161E31] transition">
              Home
            </a>
            <a href="/products" className="hover:text-slate-300 text-[#161E31] transition">
              Products
            </a>
            <a href="/about" className="hover:text-slate-300 text-[#161E31] transition">
              About
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            {user ? (
              ...
              >
                <button className="px-8 py-3 text-sm font-medium text-primary bg-[#161E31] rounded-full backdrop-blur">
                  Shop Now
                </button>
              </a>
            )}
