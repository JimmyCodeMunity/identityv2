...
const Testimonials = () => {
  ...
  const CreateCard = ({ card }) => (
    <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 bg-[#676f9d] rounded-xl w-72 shrink-0">
  ...
  return (
    <div className="bg-[#161E31]">
      ...
      <div className="w-full flex flex-row justify-center items-center py-8 sm:py-12">
        <h1 className="text-2xl text-center md:text-3xl font-bold text-[#F8B179]">
      ...
      {/* Bottom Row (Reverse) */}
      <div className="marquee-row w-full mx-auto overflow-hidden relative mt-8">
        <div className="absolute left-0 top-0 h-full w-20 z-10 pointer-events-none "></div>
